...
from matching.kl_cost import compute_KL_cost, compute_KL2_cost, compute_KL3_cost
...
def matching_upd_j(weights_j, global_weights, sigma_inv_j, global_sigmas, prior_mean_norm, prior_inv_sigma,
                   popularity_counts, gamma, J, KL_reg=0):
    ...
    if KL_reg!=0:
        ...
        #                     popularity_counts, gamma, J)
        KL_cost = KL_reg*compute_KL3_cost(global_weights, weights_j, global_sigmas, sigma_inv_j, prior_mean_norm, prior_inv_sigma,
                             popularity_counts, gamma, J)
...
def match_layer(weights_bias, sigma_inv_layer, mean_prior, sigma_inv_prior, gamma, it, assignment=None, KL_reg=0):
    J = len(weights_bias)
