...
def run_exp(n_nets):
    ...
    for trial in range(args.trials):
        ...
        with open(os.path.join(args.logdir, "n_nets "+str(n_nets), 'trial'+str(trial)+'.json'), 'w') as f:
...
if __name__ == "__main__":
    ...
    abli_exp(n_nets=args.n_nets, dataset=args.dataset, partition=args.partition)
