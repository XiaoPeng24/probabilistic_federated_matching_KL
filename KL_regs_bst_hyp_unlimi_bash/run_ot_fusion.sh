...
python ../KL_reg_unlimi.py --layers=0 --n=2 --dataset='mnist' --net_config='784, 100, 10' --experiment='ot_fusion' --epochs=10 --trials=10 --batch_size=32 --num_pool_workers=1 --device=0 --retrain=False