...
python ../KL_reg_unlimi.py --layers=0 --n=5 --dataset='mnist' --net_config='784, 100, 10' --experiment='FedAvg' --epochs=10 --trials=10 --batch_size=64 --num_pool_workers=1 --device=0 --lr 0.001